...
const servicesData: ServiceType[] = [
  {
    title: "নির্ভর যোগ্য প্রতিষ্ঠান",
    description:
      "২০০৫ সাল থেকে মুন আইটি দক্ষ ও জনশক্তি তৈরিতে নির্ভরযোগ্যতার সহিত কাজ করছে। ",
  ...
  {
    title: "দূর্বলদের জন্য বিশেষ ক্লাস",
    description:
      "দূর্বল প্রশিক্ষনার্থীদের জন্য রয়েছে বিশেষ ক্লাসের সুবিধা ও সর্বোচ্চ কেয়ারিং।",
    image: "/icons/special-class.png",
  },
  {
    title: "ব্যাচ ট্রান্সফার সুবিধা",
    description:
      "প্রশিক্ষণকালীন সময়ে ব্যাচ পরিবর্তনের সুবিধা রয়েছে শিক্ষার্থীদের সুবিধার্থে।",
  ...
  {
    title: "ক্যারিয়ার কাউন্সেলিং সাপোর্ট",
    description:
      "সফল ক্যারিয়ার গড়ার জন্য রয়েছে বিশেষজ্ঞদের কাছ থেকে ক্যারিয়ার গাইডলাইন এবং সাপোর্ট।",
