import { inter, lexendDeca } from "@/lib/fonts/fonts";
import { cn } from "@/lib/utils";
import { ReactNode } from "react";
import Header from "../shared/dashboard-layout/header";
import Sidebar from "../shared/dashboard-layout/sidebar";
...
const Layout = ({ children }: PropsTypes) => {
  return (
    <main className={cn(`flex min-h-screen flex-grow ${inter.variable} ${lexendDeca.variable} font-inter`,)}>
