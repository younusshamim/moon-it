...
const LineShapes = () => {
    return (
        <>
            ...
            <div className="absolute hidden h-14 w-[600px] rotate-[-40deg] rounded-3xl bg-secondary opacity-30 blur-2xl filter dark:hidden lg:top-20 lg:-right-28 lg:block lg:h-10 lg:w-[600px] lg:opacity-20 lg:blur-xl xl:-right-40 xl:h-2 xl:w-[800px] xl:opacity-100"></div>
            ...
            <div className="absolute h-14 w-[600px] rotate-[-40deg] rounded-3xl bg-secondary opacity-30 blur-2xl filter dark:hidden lg:bottom-20 lg:-left-28 lg:h-10 lg:w-[600px] lg:opacity-20 lg:blur-xl xl:-left-40 xl:h-2 xl:w-[800px] xl:opacity-100"></div>
