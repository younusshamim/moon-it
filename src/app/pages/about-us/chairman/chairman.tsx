    ...
    <Container className="pt-20 flex flex-col lg:flex-row gap-20 lg:gap-28 items-center justify-center">
      ...
      <div className="w-full lg:w-1/2  text-white">
        <p className="text-justify mb-4">
          বর্তমানে বিশ্বায়নের যুগে স্মার্ট সিটিজেন হতে গেলে শুধুমাত্র একাডেমিক শিক্ষায় সীমাবদ্ধ থাকা যাবে না। স্মার্ট সিটিজেন হওয়ার জন্য এই দুটি দক্ষতার প্রয়োজন ১) আইটি তথা প্রযুক্তিগত দক্ষতা ২) মাতৃভাষার পাশাপাশি অন্য আরও একটি ভাষায় দক্ষতা অর্জন। মুন আইটি আজ প্রযুক্তিগত দক্ষতা এবং ভাষা শিক্ষার ক্ষেত্রে একটি মাইলফলক স্পর্শ করতে যাচ্ছে।
        ...
        <p className=" text-justify mb-7">
          প্রযুক্তির আলো ছড়িয়ে দেওয়ার লক্ষ্যে তথা দক্ষ জনশক্তি তৈরীতে ফেনীতে আমরাই প্রথম গণপ্রজাতন্ত্রী বাংলাদেশ সরকারের শিক্ষামন্ত্রনালয়, কারিগরি শিক্ষাবোর্ড-BTEB ও প্রধানমন্ত্রীর কার্যালয়-NSDA কর্তৃক অনুমোদিত প্রতিষ্ঠান।

          মুন আইটি ২০০৫ সাল থেকে নানান বিষয়ে স্কিল ডেভেলপমেন্টের মাধ্যমে দক্ষ জনশক্তি তৈরিতে কাজ করে যাচ্ছে। বিগত প্রায় দুই দশকে আমরা অসংখ্য বেকার যুবক-যুবতির কর্মক্ষমের পাশাপাশি তৈরী করেছি অনেক উদ্যোক্তা ও ফ্রিল্যান্সার। আলহামদুলিল্লাহ বর্তমানে আমাদের অসংখ্য প্রশিক্ষনার্থী দক্ষ হয়ে দেশ-বিদেশে লোকাল ও আন্তর্জাতিক মার্কেটে কাজ করে নিজেকে প্রমাণ করার সুযোগ পাচ্ছে। আমরা আপনাদের দোয়া ও সহযোগিতা কামনা করি।
        </p>
